            ...
            <div class="page-content">
                <div class="container">
                    <section class="introduce mb-10 pb-10">
                        ...
                        <figure class="br-lg">
                            <img src="{{ static_asset('assets/images/pages/about_us/1.jpg')}}" alt="Banner" 
                    ...
                    <section class="customer-service mb-7">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 mb-8">
                                <figure class="br-lg">
                                    <img src="{{ static_asset('assets/images/pages/about_us/2.jpg')}}" alt="Banner"
                ...
                <section class="boost-section pt-10 pb-10">
                    <div class="container mt-10 mb-9">
                        <div class="row align-items-center mb-10">
                            <div class="col-md-6 mb-8">
                                <figure class="br-lg">
                                    <img src="{{ static_asset('assets/images/pages/about_us/3.jpg')}}" alt="Banner"
                                ...
                                <div class="swiper-wrapper row cols-xl-4 cols-lg-3 cols-md-2 cols-1">
                                    <div class="swiper-slide image-box-wrapper">
                                        <div class="image-box text-center">
                                            <figure>
                                                <img src="{{ static_asset('assets/images/pages/about_us/1.png')}}" alt="Award Image" width="109" height="105" />
                                            </figure>
                                    ...
                                    <div class="swiper-slide image-box-wrapper">
                                        <div class="image-box text-center">
                                            <figure>
                                                <img src="{{ static_asset('assets/images/pages/about_us/2.png')}}" alt="Award Image" width="109" height="105" />
                                            </figure>
                                    ...
                                    <div class="swiper-slide image-box-wrapper mt-3">
                                        <div class="image-box text-center">
                                            <figure>
                                                <img src="{{ static_asset('assets/images/pages/about_us/3.png')}}" alt="Award Image" width="109" height="105" />
                                            </figure>
                                    ...
                                    <div class="swiper-slide image-box-wrapper">
                                        <div class="image-box text-center">
                                            <figure>
                                                <img src="{{ static_asset('assets/images/pages/about_us/4.png')}}" alt="Award Image" width="109" height="105" />
                                            </figure>
                        ...
                        <div class="swiper-container swiper-theme" data-swiper-options="{
                            ...
                            <div class="swiper-wrapper row cols-xl-4 cols-lg-3 cols-sm-2 cols-1">
                                <div class="swiper-slide member-wrap">
                                    <figure class="br-lg">
                                        <img src="{{ static_asset('assets/images/pages/about_us/4.jpg')}}" alt="Member" width="295" height="332" />
                                        <div class="overlay">
                                ...
                                <div class="swiper-slide member-wrap">
                                    <figure class="br-lg">
                                        <img src="{{ static_asset('assets/images/pages/about_us/5.jpg')}}" alt="Member" width="295" height="332" />
                                        <div class="overlay">
                                            <div class="social-icons">
                                                <a href="#" class="social-icon social-facebook w-icon-facebook"></a>
                                                <a href="#" class="social-icon social-twitter w-icon-twitter"></a>
                                ...
                                <div class="swiper-slide member-wrap">
                                    <figure class="br-lg">
                                        <img src="{{ static_asset('assets/images/pages/about_us/6.jpg')}}" alt="Member" width="295" height="332" />
                                        <div class="overlay">
                                            <div class="social-icons">
                                                <a href="#" class="social-icon social-facebook w-icon-facebook"></a>
                                                <a href="#" class="social-icon social-twitter w-icon-twitter"></a>
                                ...
                                <div class="swiper-slide member-wrap">
                                    <figure class="br-lg">
                                        <img src="{{ static_asset('assets/images/pages/about_us/7.jpg')}}" alt="Member" width="295" height="332" />
                                        <div class="overlay">
                                            <div class="social-icons">
                                                <a href="#" class="social-icon social-facebook w-icon-facebook"></a>
                                                <a href="#" class="social-icon social-twitter w-icon-twitter"></a>
